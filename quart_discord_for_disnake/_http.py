...
class DiscordOAuth2HttpClient(abc.ABC):
    ...
    This class is meant to be overridden by :py:class:`quart_discord_for_disnake.DiscordOAuth2Session` and should not be
    used directly.
    ...
    async def request(self, route: str, method="GET", data=None, oauth=True, **kwargs) -> typing.Union[dict, str]:
        ...
        quart_discord_for_disnake.RateLimited
            Raises an instance of :py:class:`quart_discord_for_disnake.RateLimited` if application is being rate limited by Discord.
