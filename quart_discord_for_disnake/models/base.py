...
class DiscordModelsBase(metaclass=DiscordModelsMeta):
    ...
    async def _request(*args, **kwargs):
        """A shorthand to :py:func:quart_discord_for_disnake.request`. It uses Quart current_app local proxy to get the
    ...
    async def _bot_request(*args, **kwargs):
        """A shorthand to :py:func:quart_discord_for_disnake.bot_request`."""
