...
class UserConnection(DiscordModelsBase):
    ...
    async def fetch_from_api(cls, cache=True):
        ...
        who are attached to these connections then, the cached property :py:attr:`quart_discord_for_disnake.User.connections`
        is updated.
        ...
        Returns
        -------
        list[quart_discord_for_disnake.UserConnection, ...]
            List of instances of :py:class:`quart_discord_for_disnake.UserConnection` to which this user belongs.
